...
class ResultsRepository {
  ...
  ResultsRepository({required Dio dio, required SecureStorageService secureStorage})
      : _dio = dio,
        _secureStorage = secureStorage;

  Future<List<ResultTermModel>> fetchChildResults() async {
    ...
    try {
      ...
      return data.map((e) => ResultTermModel.fromJson(e as Map<String, dynamic>)).toList();
    } on DioException catch (e) {
      final dynamic data = e.response?.data;
      String message = 'Failed to load results data.';
