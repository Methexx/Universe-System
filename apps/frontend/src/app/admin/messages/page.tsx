...
type RoleFilter = "all" | "teacher" | "security";
...
const INITIAL_THREADS: Thread[] = [
  {
    id: "t1",
    contactName: "John Security",
    role: "security",
    roleLabel: "Main Gate Security",
    unread: 1,
    lastMessage: "Gate 1 needs maintenance soon.",
    lastTimestamp: "10:42 AM",
    messages: [
      {
        id: "m1",
        from: "other",
        text: "Admin, I noticed some issues with the sensor at Gate 1.",
        timestamp: "Today, 10:40 AM",
      },
      {
        id: "m2",
        from: "other",
        text: "Gate 1 needs maintenance soon.",
  ...
  },
  {
    ...
    unread: 0,
    lastMessage: "I will submit the updated syllabus by Friday.",
    lastTimestamp: "Yesterday",
    messages: [
      {
        id: "m3",
        from: "admin",
        text: "Hello Mrs. Nkwonta, could you finalize the term syllabus?",
        timestamp: "Yesterday, 2:10 PM",
      },
      {
        id: "m4",
        from: "other",
        text: "I will submit the updated syllabus by Friday.",
  ...
  },
  {
    ...
    unread: 2,
    lastMessage: "Do we have extra dry erase markers?",
    lastTimestamp: "9:15 AM",
    messages: [
      {
        id: "m5",
        from: "other",
        text: "Good morning! I ran out of supplies in room 10-A.",
        timestamp: "Today, 9:10 AM",
      },
      {
        id: "m6",
        from: "other",
        text: "Do we have extra dry erase markers?",
...
function ThreadListItem({
  ...
  const Icon = thread.role === "security" ? Shield : GraduationCap;
...
function ChatBubble({ message }: { message: Message }) {
  ...
  return (
    <div className={clsx("flex", isAdmin ? "justify-end" : "justify-start")}>
      <div
        className={clsx(
      ...
      >
        ...
        <p
          className={clsx(
            "mt-1 text-[10px]",
            isAdmin ? "text-gray-300" : "text-[#94a3b8]"
          )}
        >
          {message.timestamp}
        </p>
          ...
          <div className="border-b border-[#e2e8f0] p-4">
            <div className="relative mb-3">
              ...
              <input
                ...
                placeholder="Search staff or security…"
            ...
            <div className="flex gap-2">
              {(["all", "teacher", "security"] as RoleFilter[]).map((f) => (
                <button
                  key={f}
                  type="button"
          ...
          {activeThread ? (
            <>
              ...
              <div className="flex items-center gap-3 border-b border-[#e2e8f0] px-5 py-3.5">
                ...
                <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-[#e2e8f0] text-[#0f172a]">
                  {activeThread.role === "security" ? <Shield className="h-4 w-4" /> : <GraduationCap className="h-4 w-4" />}
                </div>
