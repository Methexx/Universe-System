...
export default function TeacherCalendarPage() {
  return (
    <div className="flex w-full flex-col gap-[20px] pb-12 pr-2">
      <PageHeader
        title="Calendar"
        subtitle="Class schedules, events, and reminders for teachers."
      />
      ...
      <div className="rounded-[24px] border border-[#e2e8f0] bg-white p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
        <div className="flex flex-col items-center justify-center gap-3 py-14 text-center">
          ...
          <h2 className="text-[18px] font-bold text-[#0f172a]">Calendar Screen Scaffold</h2>
          <p className="max-w-xl text-[14px] text-[#64748b]">
            This screen is ready for monthly calendar view, timetable sync, and event reminders.
          </p>
        </div>
      </div>
    </div>
